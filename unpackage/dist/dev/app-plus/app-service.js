...
(function(vue, shared) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "tab-control" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList(__props.titles, (item, index) => {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "goods-item" }, [
          vue.createElementVNode("image", {
            class: "image",
            "lazy-load": true,
            src: __props.goodsInfo.show.img,
            mode: "widthFix"
          }, null, 8, ["src"]),
          vue.createElementVNode("view", { class: "desc-info" }, [
            vue.createElementVNode(
              "view",
              { class: "title" },
              vue.toDisplayString(__props.goodsInfo.title),
              1
              /* TEXT */
            ),
            vue.createElementVNode("view", { class: "info" }, [
              vue.createElementVNode(
                "text",
                { class: "price" },
                "￥" + vue.toDisplayString(__props.goodsInfo.price),
                1
                /* TEXT */
              ),
              vue.createElementVNode("image", {
              ...
              vue.createElementVNode(
                "text",
                { class: "cfav" },
                vue.toDisplayString(__props.goodsInfo.cfav),
                1
                /* TEXT */
              )
            ])
          ...
          (vue.openBlock(true), vue.createElementBlock(
            ...
            vue.renderList(__props.banners, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("swiper-item", {
                key: index,
                onClick: ($event) => handleBannerClick(item.link)
              }, [
                vue.createElementVNode("image", {
                  class: "image",
                  src: item.image,
  ...
  const _sfc_main$b = {
    ...
    setup(__props, { emit: emits }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "recommend-wrapper" }, [
          (vue.openBlock(true), vue.createElementBlock(
            vue.Fragment,
            null,
            vue.renderList(__props.recommends, (item, index) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                key: index,
                class: "recommend-item",
                onClick: ($event) => recommendItemClick(item.link)
              }, [
                vue.createElementVNode("image", {
                  class: "image",
                  src: item.image,
...
This will fail in production if not fixed.`);
  ...
  const BASE_URL = "http://192.168.0.104:3007";
  class HYQuest {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "home" }, [
          ...
          vue.createVNode(HomeRecommend, {
            ...
            onRecommendItemClick: recommendItemClick
          }, null, 8, ["recommends"]),
          ...
          vue.createVNode(_component_uni_grid, {
            ...
            default: vue.withCtx(() => [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList(vue.unref(goodsList)[vue.unref(types)[currentType.value]].list, (item, index) => {
  ...
  const PagesWebviewWebview = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "E:/study/uniapp+taro/HYMallApp/pages/webview/webview.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/study/uniapp+taro/HYMallApp/App.vue"]]);
  function createApp() {
